...
public class JsonProducerDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if(kafkaConfigStream == null)
            {
            	logger.trace("Creating Kafka producer...NULL1");
            }
            
            kafkaConfigStream = JsonProducerDemo.class.getResourceAsStream(kafkaConfig);
            
            if(kafkaConfigStream == null)
            {
            	logger.trace("Creating Kafka producer...NULL2");
            }
